...
NobleBindings.prototype._onMessage = function (ws, event) {
  ...
  if (type === 'discover') {
    advertisement = {
      ...
      customData: (advertisement.customData ? Buffer.from(advertisement.customData, 'hex') : null),
      customDataLength: advertisement.customDataLength,
      dataSections: (advertisement.dataSections ? Buffer.from(advertisement.dataSections, 'hex') : null),
